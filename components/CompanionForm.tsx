...
const CompanionForm = () => {
  ...
  const onSubmit = (values: z.infer<typeof companionFormSchema>) => {
    console.log(values);
  };
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>What should the companions help with?</FormLabel>
              <FormControl>
                <Textarea
                  placeholder="Ex. Derivatives and Integrations"
                  className="input"
                  {...field}
                />
              </FormControl>
